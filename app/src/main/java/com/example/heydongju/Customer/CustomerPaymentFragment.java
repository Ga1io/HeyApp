        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(view).navigate(R.id.nav_customer_payment_to_nav_customer_home);
        ...
        mylist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(view).navigate(R.id.nav_customer_payment_to_nav_customer_mylist);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(root).navigate(R.id.nav_customer_payment_to_nav_customer_select_menu);
        ...
        mypage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(root).navigate(R.id.nav_customer_payment_to_nav_customer_mypage);
