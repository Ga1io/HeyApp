...
public class CustomerOrderFragment extends Fragment {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(root).navigate(R.id.action_customer_order_to_to_nav_customer_home);
        ...
        mylist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(root).navigate(R.id.action_customer_order_to_nav_customer_mylist);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(root).navigate(R.id.action_customer_order_to_to_nav_store);
        ...
        mypage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(root).navigate(R.id.action_customer_order_to_to_nav_customer_mypage);
    ...
    private void addMenu(View v){
        ...
        HashMap<MenuData, ArrayList<MenuData.Option>> cart = Me.getInstance().cart;

        int topId = R.id.foodScheme;

        for (Map.Entry<MenuData, ArrayList<MenuData.Option>> item : cart.entrySet()) {
            ...
            if (item.getValue() != null){
                ArrayList<MenuData.Option> options = item.getValue();
