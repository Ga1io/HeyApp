        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(root).navigate(R.id.action_customer_shopping_cart_to_nav_customer_home);
        ...
        mylist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(root).navigate(R.id.action_customer_shopping_cart_to_nav_customer_mylist);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(root).navigate(R.id.action_customer_shopping_cart_to_nav_customer_select_store);
        ...
        mypage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.isSelected()){
                    ...
                    Navigation.findNavController(root).navigate(R.id.action_customer_shopping_cart_to_nav_customer_mypage);
