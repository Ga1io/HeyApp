...
public class CustomerSelectMenuFragment extends Fragment {
    ...
    public CustomerSelectMenuFragment(){
    }

    public CustomerSelectMenuFragment(StoreData store){
        this.store = store;
    }
    ...
    private ArrayList<MenuData> makeDummy(){
